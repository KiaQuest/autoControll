...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Tarla Duzenle Sayfasi'])
                    ...
                    <form role="form" method="POST" action={{ route('tarla.edit' , ['id' => request()->id ]) }} enctype="multipart/form-data">
                        ...
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Tarlani duzenle</p>
                                <button type="submit" class="btn btn-primary btn-sm ms-auto">Kayd</button>
                            </div>
                        </div>
                        <div class="card-body">
                            <p class="text-uppercase text-sm">Tarla bilgileri</p>
                            <div class="row">
...
{{--                                <span class="text-danger field-validation-valid" data-valmsg-for="Durum" data-valmsg-replace="true"></span><br>--}}
                                ...
                                <label class="form-label" for="SatisDurumu">Satis Durumu</label>
