                                ...
                                @foreach($data as $z)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="text-xm font-weight-lighter mb-0 px-2">{{ $z->username  }}</p>
...
{{--                                            </div>--}}
                                            ...
                                            <p class="text-xs font-weight-lighter mb-0 px-2">{{ $z->firstname }}</p>
                                            <p class="text-xs font-weight-bold mb-0 px-2">{{ $z->lastname  }}</p>
