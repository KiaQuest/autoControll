...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Muşteri eklemek sayfasi'])
...
{{--                </div>--}}
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form role="form" method="POST" action={{ route('customer.ek') }} enctype="multipart/form-data">
                        @csrf
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
{{--                                <p class="mb-0">Edit Profile</p> kament--}}
                                <p class="mb-0 fs-3">Müşteri Ekle</p>
...
{{--                                        <input name="OdemeTipi" type="hidden" class="form-control" value="verecek" data-val="true" data-val-required="'Odeme Tipi' must not be empty." id="OdemeTipi">--}}
                                        ...
                                        <label class="form-label" for="OdeyenAd">Müşteri Adı<span class="req">*</span></label>
                                        <input name="ad" type="text" class="form-control"  data-val="true" id="OdeyenAd">
                                        <br>
                                        <label class="form-label" for="OdeyenAd">Müşteri Soyadı</label>
                                        <input name="soyad" type="text" class="form-control"  >
                                        <br>
                                        <label class="form-label" for="OdeyenAd">Müşteri telefonu<span class="req">*</span></label>
                                        <input name="tel" type="text" class="form-control"  >
                                        <br>
                                        <label class="form-label" for="OdeyenAd">Müşteri Adresı</label>
                                        <input name="adres" type="text" class="form-control" >
                                        <br>
                                        <label class="form-label" for="OdeyenAd">Müşteri Meilı</label>
...
{{--                                        <label class="form-label" for="FirmaAciklama">Firma Açıklaması</label>--}}
                            ...
                            <p class="text-uppercase text-sm">Diğer Vergilerı</p>
{{--                            <p class="text-uppercase text-sm">Diğer Açıklaması</p>--}}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Açıklama</label>
