...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Firma Duzenle Sayfasi'])
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form role="form" method="POST" action={{ route('firma.edit.post',['id' => $data[0]->id ]) }} enctype="multipart/form-data">
                        @csrf
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
{{--                                <p class="mb-0">Edit Profile</p> kament--}}
                                <p class="mb-0">Firma duzenle</p>
...
{{--                                </div>--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $data[0]->firma }}" name="firma" type="text" class="form-control" required data-val="true" data-val-required="The FirmaAdi field is required." id="FirmaAdi">
                                        <span class="text-danger field-validation-valid" data-valmsg-for="FirmaAdi" data-valmsg-replace="true"></span><br>
                                        <label class="form-label" for="Telefon">Telefon</label>
                                        <input value="{{ $data[0]->telefon }}" name="telefon" type="tel" class="form-control" placeholder="XXXX XXX XX XX" id="Telefon"/>
...
{{--                                        <input type="hidden" name="id" >--}}
                                        ...
                                        <input value="{{ $data[0]->eposta }}" name="eposta" type="email" class="form-control" id="Eposta">
                                        <br>
                                        <label class="form-label" for="VergiNumarasi">VergiNumarasi</label>
                                        <br>
                                        <input value="{{ $data[0]->vnum }}" name="vnum" type="text" class="form-control" id="VergiNumarasi">
                                        <br>
                                        <label class="form-label" for="Adres">Adres<span class="req">*</span></label>
                                        <input value="{{ $data[0]->adres }}" name="adres" type="text" class="form-control" required="" data-val="true" data-val-required="The Adres field is required." id="Adres">
{{--                                        <span class="text-danger field-validation-valid" data-valmsg-for="Adres" data-valmsg-replace="true"></span>--}}
                                        ...
                                        <input value="{{ $data[0]->notlar }}" name="notlar" type="text" class="form-control" id="Notlar">
                                        <br>
                                        <label class="form-label" for="YetkiliAd">Firma Yetkilisi Ad</label>
                                        <input value="{{ $data[0]->yetkiliad }}" name="yetkiliad" type="text" class="form-control"  data-val="true" data-val-required="The YetkiliAd field is required." id="YetkiliAd">
{{--                                        <span class="text-danger field-validation-valid" data-valmsg-for="YetkiliAd" data-valmsg-replace="true"></span>--}}
                                        ...
                                        <input value="{{ $data[0]->yetkilisoyad }}" name="yetkilisoyad" type="text" class="form-control"  data-val="true" data-val-required="The YetkiliSoyad field is required." id="YetkiliSoyad">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="durum" id="durum" class="form-control" style="appearance:button">
                                                    <option value="0">Aktif</option>
                                                    <option value="1" {{ ($data[0]->durum == 1 ? 'selected' : '') }}>Pasif</option>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $data[0]->about }}" class="form-control" type="text" name="about"
                                            >
                                    </div>
                                </div>
                            </div>
