...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'şikayet ekleme sayfasi'])
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form role="form" method="POST" action={{ route('sikayet.create') }} enctype="multipart/form-data">
                        @csrf
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">şikayet ekle</p>
                                <button type="submit" class="btn btn-primary btn-sm ms-auto">Kaydet</button>
                            </div>
                        </div>
                        <div class="card-body">
                            <p class="text-uppercase text-sm">şikayet bilgileri</p>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <label class="form-label" for="Ada">Şikayet Metni <span class="req">*</span></label>
