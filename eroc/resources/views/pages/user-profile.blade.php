...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Senin Profilin'])
                    ...
                    <form role="form" method="POST" action={{ route('profile.update') }} enctype="multipart/form-data">
                        ...
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Profili Düzenle</p>
                                <button type="submit" class="btn btn-primary btn-sm ms-auto">Kaydet</button>
                            </div>
                        </div>
                        <div class="card-body">
                            <p class="text-uppercase text-sm">Kullanıcı bilgisi</p>
                            <div class="row">
{{--                                <div class="col-md-6">--}}
...
{{--                                </div>--}}
                                <div class="col-6">
                                    <h4 style="text-shadow: 2px 1px #ff8300;"> - -
                                        GIRIŞ Adin  :    {{ auth()->user()->username }}
                                    </h4>
                                </div>
                                <div class="col-6">
                                    <h4 style="text-shadow: 1px 1px #342d62;"> - -
                                        Rol  :    
