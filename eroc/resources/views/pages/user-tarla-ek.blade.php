...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Tarla Eklemek sayfasi'])
...
// console.log('1')
                                    ...
                                    <input name="Ada" type="text" class="form-control" id="Ada" required>
