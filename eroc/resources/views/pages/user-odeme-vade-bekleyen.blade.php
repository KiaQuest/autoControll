                                        ...
                                        <td class="align-middle ">
                                            <div class="vadeislem">
                                                ...
                                                <a href="{{ route('odeme.vade.onayla' , [ 'id' => $z->id ]) }}"><span
                                                        class="badge badge-sm bg-gradient-success"><i class="fa fa-check"></i></span></a></div>
                                                <div>
    {{--                                            <button type="button" class="btn btn-danger btn-lg btnkia"--}}
    {{--                                                    onclick="sor({{ $z->id }})"><i class="fa fa-trash  text-sm"> sil</i></button>--}}
                                                <button type="button" class=" btn-info btn-sm btnkia yechizi sil " id="b{{ $loop->iteration }}"
