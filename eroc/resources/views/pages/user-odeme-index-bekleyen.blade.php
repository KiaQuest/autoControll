...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Onay Bekliyen Ödemeler'])
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Onay Bekliyen Ödemeler Tablosu</h6>
                    </div>
...
{{--                                        </td>--}}
                                        <td>
                                            ...
                                            <p class="text-sm font-weight-lighter mb-0 px-2">{{ Str::limit($z->About, 30)   }} {{ $z->About != null ? '/' : '' }} {{ Str::limit($z->OdemeAciklama, 25) }}</p>
                                            ...
                                            <div class="tdislem">
                                                ...
                                                @if($z->OdemeAciklama == 'ihtiac' && $z->cid != null)
                                                    <a href="{{ route('odeme.sil' , ['id' => $z->id , 'kapora' => 0]) }}"><button type="button" class="btn  btn-lg btnkia" style="background-color: #f59f00; color: white"
                                                           ><i class="fa fa-trash "> sil</i></button></a>
                                                @else
                                                    <button type="button" class="btn btn-danger btn-lg btnkia"
                                                            onclick="sor({{ $z->id }})"><i class="fa fa-trash text-xl yechizi"> sil</i></button>
                                                @endif

                                                <button type="button" class="btn btn-info btn-sm btnkia yechizi sil" id="b{{ $loop->iteration }}"
