...
{{--                                                <option value="kart">kart</option>--}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="kapora" id="kapora" class="form-control" required>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="kalan">Kalan</label>
                                            <input type="text" name="kalan" id="kalan" class="form-control">
                                        </div>
...
//                                         let all = 'http://127.0.0.1:8000/api/tarlalar'
                                        let all = 'api/tarlalar'
                                        {{--let q1 = {{ auth()->user()->id }};--}}
                                        {{--let q2 = '/';--}}
